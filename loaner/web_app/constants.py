...
APP_DOMAINS = ['demo.grab-and-go.uk']
...
ON_PROD = ON_GAE and ('grabandgo-265116' in APPLICATION_ID)
...
ADMIN_EMAIL = 'Jcowie@demo.grab-and-go.uk'

# The email address application emails will come from.
SEND_EMAIL_AS = 'no-reply@demo.grab-and-go.uk'
...
SUPERADMINS_GROUP = 'technical-admins@demo.grab-and-go.uk'

# The PROD server specific configurations.
if ON_PROD:
  # The OAuth2 Client ID for the Chrome Application.
  CHROME_CLIENT_ID = '441590241095-scro77bjkhfllm6d6jfbi8s0orbs31sa.apps.googleusercontent.com'
  # The OAuth2 Client ID for the Web Application Frontend.
  WEB_CLIENT_ID = '441590241095-tur65rhabhpi3cjtk75ij72324dqspoa.apps.googleusercontent.com'
