...
export const PROD = 'grabandgo-265116';

/** The url for the Google Cloud Endpoints API for your application. */
export const WEB_CLIENT_IDS: EnvironmentsVariable = {
  prod: `441590241095-tur65rhabhpi3cjtk75ij72324dqspoa.apps.googleusercontent.com`,
  qa: `{QA_WEB_ID}`,
  dev: `{DEV_WEB_ID}`,
};
...
export const CHROME_PUBLIC_KEYS: EnvironmentsVariable = {
  prod: '',
  qa: '{QA_CHROME_KEY}',
  dev: '{DEV_CHROME_KEY}',
};
...
export const IT_CONTACT_PHONE = ['01473 243489'];
